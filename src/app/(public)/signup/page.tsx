...
import { User, Phone, Mail, Lock, AlertCircle, ArrowRight, Loader2, MailCheck } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (signUpError) {
        ...
        // Session exists — user is already signed in (no email confirmation required)
          ...
          <div className="text-center mb-8">
            {confirmationSent ? (
              <>
                ...
                <h2 className="text-2xl font-bold text-text-primary mb-2">ইমেইল যাচাই করুন</h2>
                <p className="text-text-secondary text-sm">
                  {email} এ একটি কনফার্মেশন ইমেইল পাঠানো হয়েছে। আপনার অ্যাকাউন্ট অ্যাক্টিভেট করতে ইমেইলের লিংকে ক্লিক করুন।
                </p>
              </>
            ) : (
              <>
